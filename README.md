...
Simply change the experiment name in the CLI call to run any of the three example experiments.
...
| `globals.atom_types` | `[1, 6, 7, 8, 9]` | List of all the atom types contained in molecules of the training data set (expressed as nuclear charges, i.e. here we have 1, 6, 7, 8, and 9 for H, C, N, O, and F, respectively). |
